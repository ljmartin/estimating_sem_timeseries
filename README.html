...
<h1 id="Intro-to-confidence-intervals-for-time-series">Intro to confidence intervals for time series<a class="anchor-link" href="#Intro-to-confidence-intervals-for-time-series">&#182;</a></h1><p>This page compares different methods of calculating the SEM for a stationary time series.</p>
<p>It compares the popular 'block average' to several alternatives. Bayes model of an AR(1) process fares best in cases of limited data.</p>
...
<div class=" highlight hl-ipython3"><pre><span></span><span class="kn">import</span> <span class="nn">plot_utils</span>
<span class="n">plot_utils</span><span class="o">.</span><span class="n">plot_results_interactive</span><span class="p">()</span>
<span class="c1">#plot_utils.plot_results_static()</span>
</pre></div>
...
<div id="altair-viz-da32b5ef3d294e91b22466be2521a671"></div>
<script type="text/javascript">
  (function(spec, embedOpt){
    let outputDiv = document.currentScript.previousElementSibling;
    if (outputDiv.id !== "altair-viz-da32b5ef3d294e91b22466be2521a671") {
      outputDiv = document.getElementById("altair-viz-da32b5ef3d294e91b22466be2521a671");
    }
    const paths = {
